...
map.getView().fit([-14759945.464413, 5988624.465546, -10359164.998203, 8306003.917487], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Waterbodies and Fish Stocks of Alberta</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (70 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Projection: EPSG:3403 - NAD83 / Alberta 10-TM (Forest)<br />Author: Will Wu';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_FishStockingPoints_3,
    colName: 'SPECIES',
    zoom: 10,
    collapsed: true,
    map: map
